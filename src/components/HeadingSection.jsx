...
import MezrawIcon from '../assets/mezrawsolutions.jpeg'
...
'>Pioneering Progress Powered by Trust</h1></FadeinSection>
  <FadeinSection><img src={MezrawIcon} alt='Atlassian Logo' className='w-[148px] h-[148px] mt-4 mb-4' /></FadeinSection>
